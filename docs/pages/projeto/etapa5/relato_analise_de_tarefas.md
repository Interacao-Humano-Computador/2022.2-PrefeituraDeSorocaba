...
Esta avaliação tem por objetivo analisar tarefas dos usuários do site da [Prefeitura de Sorocaba](https://www.sorocaba.sp.gov.br/) através do método de inspeção do Percurso Cognitivo.

O percurso cognitivo é um método de inspeção de usabilidade que foca em avaliar um design pela facilidade de aprendizado, particularmente através da exploração. O foco é motivado pela observação de que muitos usuários preferem aprender sobre um software pela exploração do mesmo, aprendendo sobre as suas funcionalidades enquanto executam tarefas que exigem o uso das mesmas, ao invés de ler manuais formais sobre estas funcionalidades. Neste método, os pesquisadores avaliam uma interface no contexto de uma ou mais tarefas expecíficas do usuário (Wharton et al, 1994).

Durante o processo do percurso, são consideradas, em sequência, cada uma das ações do usuário necessárias para completar a tarefa. Para cada ação, é contada uma história sobre uma interação típica do usuário com a interface. É perguntado o que o usuário estaria tentando fazer neste ponto e que ações a interface disponibiliza. Se o design da interface é bom, as intenções do usuário deveriam fazê-lo selecionar a ação apropriada. Após a ação, a interface deve apresentar um feedback claro indicando que o usuário está fazendo progresso na direção de completar a tarefa.
...
A execução de cada tarefa foi realizada, respondendo às perguntas fornecidas pelo método. A coleta e interpretação dos dados para cada tarefa e suas respectivas ações é apresentada a seguir.
...
- P1. O usuário vai tentar atingir o efeito correto? (Vai formular a intenção correta?)
  - Sim, pois a ação é familiar ao usuário
- P2. O usuário vai notar que a ação correta está disponível?
  - Sim, pois a interface deixa explícito que para ler uma notícia por completo você deve clicar nela
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois por experiência ou intuição, consegue saber que para ler a notícia precisa clicar nela
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
  - Sim, pois ao clicar em uma notícia, uma nova página é aberta com o nome da notícia, um artigo sobre o que se noticia e em alguns casos também imagens relacionadas com a notícia
...
- P2. O usuário vai notar que a ação correta está disponível?
  - Sim, pois o botão está disponível na página
  - Ou não, pois o botão "Concurso" está localizado em um dos muitos menus na página, o que dificulta uma localização rápida do botão
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois o título do botão é explícito sobre ao que se refere
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
...
- P2. O usuário vai notar que a ação correta está disponível?
  - Sim, pois ao entrar nesta página são exibidos os diversos concursos
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois por experiência ou intuição vai imaginar que necessita clicar no concurso específico para acessar sua página
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
...
- P2. O usuário vai notar que a ação correta está disponível?
  - Não, pois em alguns concursos a página não apresenta nenhum arquivo ou informação sobre o concurso
  - Ou sim, pois alguns concursos contém uma lista das publicações e editais
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois por experiência ou intuição e a boa localização das publicações na página, o usuário vai descobrir que clicando no nome da publicação, ele consegue acessá-la
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
  - Sim, pois ao clicar em uma publicação, é aberta uma nova aba com o arquivo por completo para ser visualizado
...
- P2. O usuário vai notar que a ação correta está disponível?
  - Sim, pois o botão está disponível na página
  - Ou não, pois o botão "IPTU" está localizado em um dos muitos menus na página, o que dificulta uma localização rápida do botão
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois o título do botão é explícito sobre ao que se refere
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
...
- P2. O usuário vai notar que a ação correta está disponível?
  - Sim, pois a opção de segunda via de IPTU é a primeira mostrada na página
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois o nome do botão é condizente com o objetivo que deseja alcançar naquele momento
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
...
- P2. O usuário vai notar que a ação correta está disponível?
  - Sim, pois o campo está marcado como item obrigatório para a consulta e é de fácil localização na página
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois essa é a informação necessária para consultar a segunda via de IPTU
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
...
- P2. O usuário vai notar que a ação correta está disponível?
  - Não, pois o botão não está lozalizado de forma intuitiva e possui um nome muito específico e um símbolo incomum para consultas
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois ao saber que o botão é para realizar consultas e não ver outra opção na página, por exclusão vai saber que é o botão correto
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
  - Sim, pois se exibirá uma página com valores devidos e a pagar de seu IPTU
...
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois por excesso, ao selecionar uma das opções relacionadas à doação, qualquer opção seria a correta
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
...
- P2. O usuário vai notar que a ação correta está disponível?
  - Sim, pois existe na notícia uma seção com o título "Saiba onde doar"
  - Ou não, pois esta informação se encontra apenas no final do artigo, após uma reportagem
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois está relativamente claro na página onde encontrar a informação
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
...
- P1. O usuário vai tentar atingir o efeito correto? (Vai formular a intenção correta?)
  - Sim, pois o usuário quer as informações que a página fornece
- P2. O usuário vai notar que a ação correta está disponível?
  - Não, pois a informação encontra-se dentro de uma seção específica apenas no final do texto, após uma reportagem
  - Ou sim, pois na seção "Saiba onde doar" se encontra a informação do número de telefone, então após certa procura, irá encontrar o número
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois ao conseguir identificar o número de telefone vai saber que é o que precisa
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
  - Sim, pois terá obtido a informação que desejava
...
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois por excesso, ao selecionar uma das opções relacionadas ao Nota da Bolada, qualquer opção seria a correta
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
...
- P2. O usuário vai notar que a ação correta está disponível?
  - Sim, pois a interface deixa aparente um botão com o nome "Sorteios"
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois vai imaginar que o botão "Sorteios" é para o que deseja
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
...
- P2. O usuário vai notar que a ação correta está disponível?
  - Sim, pois a interface mostra informações sobre os sorteios
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois caso a informação que ele deseja esteja disponível, será fácil de achar, pois as informações estão explicitamente expostas na página
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
...
- P2. O usuário vai notar que a ação correta está disponível?
  - Não, pois apesar de aparentar ser a ação correta, não há ação correta, pois nenhum sorteio mostra o(s) contribuinte(s) sorteado(s)
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Não, pois não há ação correta
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
  - Não, pois não há possibilidade de visualizar o(s) contribuinte(s) sorteado(s)
...
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois por excesso, ao selecionar uma das opções relacionadas ao Procon Sorocaba, qualquer opção seria a correta
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
...
- P2. O usuário vai notar que a ação correta está disponível?
  - Sim, pois a interface deixa aparente um botão com o nome "Atendimento"
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Não, pois não é comum associar o título "Atendimento" a uma página de informações sobre algo
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
...
- P2. O usuário vai notar que a ação correta está disponível?
  - Sim, pois a página mostra com clareza as informações
- P3. O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Sim, pois por experiência ou intuição, vai procurar a informação que deseja na página
- P4. Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
  - Sim, pois terá obtido as informações que desejava
...
- Tarefa: Acessar a aba “Concursos e Processos Seletivos”
  ...
  - Local na interface onde ocorreu o problema: Página “Concursos e Processos Seletivos”
  - Este caso é um problema em que a funcionalidade não está disponível, então o usuário precisaria a priori saber para quais concursos haverão as publicações, e que para alguns concursos em específico não haverão publicações.
  - Enquanto realiza a tarefa, o usuário deve aprender que a funcionalidade de visualizar as publicações não se aplica a todos os concursos, esperando assim encontrar concursos para os quais a funcionalidade não se aplica.
...
- Tarefa: Consultar 2° via de IPTU
  ...
  - Ou não, pois o botão "IPTU" está localizado em um dos muitos menus na página, o que dificulta uma localização rápida do botão
  - Local na interface onde ocorreu o problema: Página da prefeitura, segundo menu
  - Para não cair nesse problema, o usuário deve a priori ter experiência com a interface do site, sabendo em que menu o botão se encontra.
  - Ao realizar essa tarefa, o usuário deve aprender sobre a disposição dos elementos na página, que não segue um padrão muito intuitivo.
...
- Tarefa: Consultar 2° via de IPTU
  ...
  - Local na interface onde ocorreu o problema: Página de consulta da segunda via de IPTU
  - Para não cair nesse problema, o usuário deveria saber a priori que aquele botão é o de pesquisa.
...
-Tarefa: Encontrar informações sobre doação de plaquetas em Sorocaba
  ...
  - Problema: O usuário vai notar que a ação correta está disponível?
  - Resposta: Não, pois o botões de doação de plaquetas estão dispostos em um carrosel com diversas informações que fica girando e se não estiver aparente no momento, a única maneira de encontrá-los é clicando em um outro menu, que não vai diretamente pra doação de plaquetas, mas torna aparente as opções relaciondas à doação de plaquetas no carrossel
  - Local na interface onde ocorreu o problema: Página da prefeitura, carrossel de funcionalidades
  - Para não ter este problema, o usuário deveria saber a priori diversas coisas: que aquele elemento é um carrossel que fica mudando o que exibe; que as informações sobre doação de plaquetas podem ser acessadas por lá; que ele pode clicar em três opções diferentes para acessar essas informações.
  - Ao realizar a tarefa, o usuário deve aprender que pode selecionar o que vai ser exibido no carrossel clicando no menu abaixo dele e que esse menu não leva à página desejada, mas apenas mexe no carrossel, e também que é ali que essa informação específica vai estar dentre todas as informações na página, que estão espalhadas.
...
- Tarefa: Encontrar informações sobre doação de plaquetas em Sorocaba
  ...
  - Encontrar o número de telefone para informações sobre a doação de plaquetas
  - Problema: O usuário vai notar que a ação correta está disponível?
  - Resposta: Sim, pois existe na notícia uma seção com o título "Saiba onde doar"
  - Ou não, pois esta informação se encontra apenas no final do artigo, após uma reportagem
  - Local na interface onde ocorreu o problema: Página da doação de plaquetas
  - Para não cair no problema, o usuário deve a priori saber que a página se trata apenas de uma notícia sobre um evento que ocorreu no ano de 2022, e que as informações provavelmente estão no final.
  - Ao realizar a tarefa o usuário deve aprender que aquela página é a única com informações sobre a doação de plaquetas, então, por exclusão, a informação só pode estar ali.
...
- Tarefa: Visualizar os sorteios realizados pelo “Nota da Bolada”
  ...
  - Resposta: Não, pois o botões relacionados ao Nota da Bolada estão dispostos em um carrosel com diversas informações que fica girando e se não estiver aparente no momento, a única maneira de encontrá-los é clicando em um outro menu, que não vai diretamente para a página do Nota da Bolada, mas torna aparente as opções relaciondas ao Nota da Bolada no carrossel
  - Local na interface onde ocorreu o problema: Página da prefeitura, carrossel de funcionalidades
  - Para não ter este problema, o usuário deveria saber a priori diversas coisas: que aquele elemento é um carrossel que fica mudando o que exibe; que as informações sobre o Nota da Bolada podem ser acessadas por lá; que ele pode clicar em três opções diferentes para acessar essas informações.
  - Ao realizar a tarefa, o usuário deve aprender que pode selecionar o que vai ser exibido no carrossel clicando no menu abaixo dele e que esse menu não leva à página desejada, mas apenas mexe no carrossel, e também que é ali que essa informação específica vai estar dentre todas as informações na página, que estão espalhadas.
...
- Tarefa: Visualizar os sorteios realizados pelo “Nota da Bolada”
  ...
  - Resposta: Não, pois apesar de aparentar ser a ação correta, não há ação correta, pois nenhum sorteio mostra o(s) contribuinte(s) sorteado(s)
  - O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Resposta: Não, pois não há ação correta
  - Se a ação for executada corretamente, o usuário vai perceber que está progredindo na direção de concluir a tarefa?
  - Resposta: Não, pois não há possibilidade de visualizar o(s) contribuinte(s) sorteado(s)
  - O usuário deve saber a priori que aquela é uma funcionalidade que não foi implementada.
  - O usuário deve aprender enquanto realiza a tarefa que a visualizar informações do(s) contribuinte(s) sorteado(s) não é possível.
...
- Tarefa: Encontrar informações sobre o Procon de Sorocaba
  ...
  - Resposta: Não, pois o botões relacionados ao Procon Sorocaba estão dispostos em um carrosel com diversas informações que fica girando e se não estiver aparente no momento, a única maneira de encontrá-los é clicando em um outro menu, que não vai diretamente para a página do Procon Sorocaba, mas torna aparente as opções relaciondas ao Procon Sorocaba no carrossel
  - Local na interface onde ocorreu o problema: Página da prefeitura, carrossel de funcionalidades
  - Para não ter este problema, o usuário deveria saber a priori diversas coisas: que aquele elemento é um carrossel que fica mudando o que exibe; que as informações sobre o Procon Sorocaba podem ser acessadas por lá; que ele pode clicar em três opções diferentes para acessar essas informações.
  - Ao realizar a tarefa, o usuário deve aprender que pode selecionar o que vai ser exibido no carrossel clicando no menu abaixo dele e que esse menu não leva à página desejada, mas apenas mexe no carrossel, e também que é ali que essa informação específica vai estar dentre todas as informações na página, que estão espalhadas.
  - Deixamos como sugestão de correção na interface também colocar as informações sobre o Procon Sorocaba em algum lugar fora do carrossel, para facilitar que seja encontrado na página.

- Tarefa: Encontrar informações sobre o Procon de Sorocaba
  - Ação: Clicar no botão "Atendimento"
  - Problemas:
  - O usuário vai tentar atingir o efeito correto? (Vai formular a intenção correta?)
  - Resposta: Não, pois não vai imaginar que as informações a respeito do Procon Sorocaba estão na aba "Atendimento", sendo esse um caso de má escolha de título
  - O usuário vai associar a ação correta com o efeito que está tentando atingir?
  - Resposta: Não, pois não é comum associar o título "Atendimento" a uma página de informações sobre algo
  - Para contornar ambos os problemas, o usuário deve saber a priori que o site do Procon Sorocaba utiliza a aba "Atendimento" para fornecer informações como telefone, endereço etc.
  - Ao realizar a tarefa, o usuário aprende que o local de encontrar certas informações sobre o Procon Sorocaba é na aba "Atendimento", o que não é muito intuitivo por ser mais comum essas informações estarem em abas nomeadas de outras formas.
  - Como sugestões de correção na interface deixamos a de separar as informações presentes na página, deixando a opção de denúncia e telefone na de atendimento, e colocando as de endereços e também de tefone em uma outra aba, "Informações" ou mesmo no rodapé da página.

## Referências Bibliográficas

> WHARTON, C.; RIEMAN, J.; LEWIS, C.; POLSON, P. The cognitive walkthrough method: A practitioner’s guide. In Nielsen, J., and Mack, R. (Org.). Usability inspection methods. Nova Iorque: John Wiley & Sons, Inc, 1994.
